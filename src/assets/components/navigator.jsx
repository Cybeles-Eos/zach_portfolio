   ...
   return(
      <>
         <header className="w-full h-[9vh] sticky top-[86%] px-2">
            <nav className="max-w-[440px] h-[3.5rem] p-2 mx-auto border flex border-[var(--navigator-brd)] bg-[var(--navigator-bg)] gap-1 rounded-lg">
               <Link className={`link flex-center ${active == 'home' ? 'active' : 'hover:opacity-[.8]'}`} to='/'>Home</Link>
               <Link className={`link flex-center ${active == 'project' ? 'active' : 'hover:opacity-[.8]'}`} to='/project'>Project</Link>
               <Link className={`link flex-center ${active == 'about' ? 'active' : 'hover:opacity-[.8]'}`} to='/about'>About</Link>
